...
(defun company-combine-transformer (candidates)
  ...
  (let ((company-prefix (company-combine-get-prefix)))
    (dolist (candidate candidates)
      (puthash candidate (or (and company-prefix (fuz-calc-score-skim company-prefix candidate)) 0) company-combine-sort-hashtable))
...
(defun company-combine-extract-prefix (prefix)
  (cond
